(async function () {
  ...
  const SINGLETON_REPEATERS = new Set(['introduction', 'contactCta', 'highlight', 'keySolutionAreasIntro', 'whoWeServe', 'businessImpactIntro', 'businessImpactLead', 'workProcessIntro', 'impactStat', 'whyChooseUs', 'whyChooseUsList', 'commonIssues', 'acctIntro', 'ravSection', 'installationProcessLead', 'installationProcessIntro']);
