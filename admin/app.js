(async function () {
  ...
  function repeaterContent() { return { heroSlides: collectRepeater('heroSlides'), cards: collectRepeater('cards'), introduction: collectRepeater('introduction'), contactCta: collectRepeater('contactCta'), faqs: collectRepeater('faqs'), testimonials: collectRepeater('testimonials'), highlight: collectRepeater('highlight'), expertCards: collectRepeater('expertCards'), managedSlides: collectRepeater('managedSlides'), servicesList: collectRepeater('servicesList') }; }
