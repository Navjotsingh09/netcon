(function () {
  ...
  function applyPageContent(content) {
    ...
    if (pageContent.businessImpactLead) { const heading = document.getElementById('biz-lead-h') || document.querySelector('h2.biz-lead'); const paragraph = heading?.nextElementSibling; if (heading && pageContent.businessImpactLead.heading) heading.textContent = pageContent.businessImpactLead.heading; if (paragraph && paragraph.tagName === 'P' && pageContent.businessImpactLead.paragraph) paragraph.textContent = pageContent.businessImpactLead.paragraph; }
