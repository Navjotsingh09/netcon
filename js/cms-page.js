(function () {
  ...
  const pageSlugs = { '/': 'home', '/index.html': 'home', '/about': 'about', '/about.html': 'about', '/contact': 'contact', '/contact.html': 'contact', '/services': 'services', '/services/index.html': 'services', '/services/network-consultancy': 'network-consultancy', '/services/network-consultancy.html': 'network-consultancy' };
