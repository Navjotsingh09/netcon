...
(function () {
  ...
  var pageDefaults = {
    ...
    '/services/network-design-deployment.html': { family: 'services', page: 'network_design_deployment', cta: 'shared_footer_form' },
    ...
    '/services/remote-access-vpn.html': { family: 'services', page: 'remote_access_vpn', cta: 'shared_footer_form' },
    '/services/firewall-network-security.html': { family: 'services', page: 'firewall_network_security', cta: 'shared_footer_form' },
    '/services/business-continuity.html': { family: 'services', page: 'business_continuity', cta: 'shared_footer_form' },
    ...
    '/solutions/ai-ready-infrastructure.html': { family: 'solutions', page: 'ai_ready_infrastructure', cta: 'shared_footer_form' },
    '/solutions/cyber-security-review.html': { family: 'solutions', page: 'cyber_security_review', cta: 'shared_footer_form' },
    '/solutions/microsoft-365-network.html': { family: 'solutions', page: 'microsoft_365_network', cta: 'shared_footer_form' },
    ...
    '/industries/healthcare-clinics.html': { family: 'industries', page: 'healthcare_clinics', cta: 'shared_footer_form' },
    ...
    '/resources/blog/': { family: 'resources', page: 'blog_index', cta: 'shared_footer_form' },
    '/resources/blog/post-': { family: 'resources', page: 'blog_post', cta: 'shared_footer_form' },
