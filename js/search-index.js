(function () {
  ...
  window.SEARCH_INDEX = [
    ...
    { title: 'Professional Services', url: '/industries/educational-institutes', category: 'industries', keywords: ['professional services'], audience: ['manager'], intents: ['discover'] },
